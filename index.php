  ...
  <div class="main-container">
    ...
    <div class="testimonials-container">
      ...
      <div class="testimonial-grid">
        ...
        <div class="testimonial-card">
          <p class="testimonial-text">
            المنصة رائعة، كنلقى فيها خدمات بكل سهولة، وكاين ثقة بين المستخدمين.
            نتمناو تزيدو تطوروها وتدخلو تطبيق ديال الهاتف قريبا.
          </p>
          <div>
            <div class="rating">
              <span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span><span class="star">★</span>
            ...
            <div class="user-info">
              <div class="user-details">
                <h4>Oussama Karimi</h4>
                <p>عضو موثوق</p>
              </div>
              <div class="user-avatar">
                <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Oussama Karimi" />
              </div>
            </div>
          </div>
        </div>
